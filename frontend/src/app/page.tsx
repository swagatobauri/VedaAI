      ...
      <div className="w-full md:w-1/2 lg:w-[480px] h-full flex flex-col justify-center px-8 md:px-16 bg-white shadow-[20px_0_60px_rgba(0,0,0,0.1)] z-10 relative">
        <div className="flex items-center gap-2 mb-12">
          <div className="relative w-[40px] h-[40px]">
            <Image src="/assets/logo.svg" alt="VedaAI Base Logo" fill className="object-contain" />
            <Image src="/assets/upperlayerlogo.svg" alt="VedaAI Upper Logo" fill className="object-contain z-10" />
          </div>
          <span className="text-gray-900 font-[family-name:var(--font-bricolage)] font-bold text-[28px] tracking-tight">
            VedaAI
          </span>
        </div>
