...
import { ArrowRight, Sparkles, Mail, Lock, Eye, EyeOff, Loader2 } from "lucide-react";
    ...
    <div className="flex h-screen w-full bg-[#EDEDED] overflow-hidden">
      ...
      <div className="w-full md:w-1/2 lg:w-[480px] h-full flex flex-col justify-center px-8 md:px-16 bg-white shadow-[20px_0_60px_rgba(0,0,0,0.1)] z-10 relative">
        ...
        <button
          ...
          className="w-full h-[46px] bg-white border border-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 mb-6 hover:shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isGoogleLoading ? (
